...
//  ForaBuild
//
//  Created by Роман Давыдов on 18.08.2018.
...
extension UIImage {
    ...
    static let names: [String] = ["Еда, продукты питания", "Межбанковкие переводы", "Мобильная Связь", "Одежда и обувь", "Коммунальные услуги", "Во имя повелителя", "Снятие наличных"]
